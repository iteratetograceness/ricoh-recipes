...
function ListItem({
  ...
  return (
    <Link
      href={`/recipe/${key}`}
      className='bg-white min-w-[240px] flex flex-col border-[0.5px] border-solid border-current rounded-xl'
    >
      ...
      <div className='p-4 text-black'>
        <span
          className={`${italicFont.className} text-xl sm:text-3xl xl:text-5xl`}
        >
          {key} {recipe.name}
        </span>
        ...
        <div className='text-xs sm:text-base'>
          <b>WHITE BALANCE:</b> {recipe.whiteBalance.type}{' '}
          {recipe.whiteBalance.value} {recipe.whiteBalance.k}
        </div>
        <hr className='my-3 border-t-[0.5px] border-current border-solid' />
        <div className='grid grid-cols-2 gap-1 sm:gap-2 text-xs sm:text-base'>
          <div className='flex items-center gap-2'>
            <b>SATURATION:</b> <PositiveOrNegative value={recipe.saturation} />
          </div>
          <div className='flex items-center gap-2'>
        ...
        <hr className='my-3 border-t-[0.5px] border-current border-solid' />
        <div className='text-xs sm:text-base'>
          <b>CREATED BY:</b> {recipe.credit}
        </div>
        <hr className='my-3 border-t-[0.5px] border-current border-solid' />
        <div className='flex gap-1 items-center font-medium text-xs sm:text-base'>
