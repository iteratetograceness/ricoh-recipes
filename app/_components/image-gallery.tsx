...
export function ImageGallery({ recipeName, photos }: {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 -mx-10">
          <div className="relative w-full md:w-3/5 h-auto aspect-[6/4] bg-gray-100 justify-self-end self-end">
          ...
          <div className="relative w-full md:w-3/5 h-auto aspect-[6/4] bg-gray-100">
